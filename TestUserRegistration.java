package com.userregistration.test.java;
...
public class TestUserRegistration {
    ...
    static String [ ] valid={"abc@yahoo.com" ,"abc-100@yahoo.com"  ,"abc.100@yahoo.com" , "abc111@abc.com" ,"abc-100@abc.net", "abc.100@abc.com.au",
            "abc@1.com" ,"abc_xyz@gmail.com","abc@gmail.com.com" ,"abc+100@gmail.com","abc@yahoo.com", "asdsf-100@yahoo.com",
    ...
    static String [ ] validpwd={"geethkiran@2M","nndakxfg4#L" , "badsspofG*1h", "masgafgt$T6i"};
    static String [ ] invalidpwd={"geethkirani2M","nndakxfg#L" , "badsspofG1h", "masgafgt$6i","nnads","123znZ>v" , "gsftgf3;lhj"};
    @Test
    public void checkForShortLengthName(){
        Assert.assertEquals(false, UserRegistration.validateUserName("Na"));
    }
    @Test
    public void checkForSpecialCharInName(){
        Assert.assertEquals(false, UserRegistration.validateUserName("geethkiran"));
    }
    @Test
    public void checkForNumInName(){
        Assert.assertEquals(false, UserRegistration.validateUserName("Ma8v"));
    }
    @Test
